...
public class GeneralSettingEntity {
    ...
    public int getOvertimeFeePerHour() {
        return overtimeFeePerHour;
    }

    public void setOvertimeFeePerHour(int overtimeFeePerHour) {
        this.overtimeFeePerHour = overtimeFeePerHour;
    }

    public int getDefaultDailyRate() {
        return defaultDailyRate;
    }

    public void setDefaultDailyRate(int defaultDailyRate) {
