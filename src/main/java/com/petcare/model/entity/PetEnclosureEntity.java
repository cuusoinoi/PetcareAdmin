...
public class PetEnclosureEntity {
    ...
    public String getPetEnclosureStatus() { return petEnclosureStatus; }
    public void setPetEnclosureStatus(String petEnclosureStatus) { this.petEnclosureStatus = petEnclosureStatus; }
}
