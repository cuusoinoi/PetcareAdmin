...
CREATE TABLE customers (
    ...
    customer_identity_card VARCHAR(12),
...
CREATE TABLE doctors (
    ...
    doctor_identity_card VARCHAR(12),
...
CREATE TABLE pets (
    ...
    pet_sterilization VARCHAR(1),
    pet_characteristic TEXT,
...
CREATE TABLE medical_records (
    ...
    medical_record_type VARCHAR(50) NOT NULL,
    medical_record_visit_date DATE NOT NULL,
    medical_record_summary TEXT,
    medical_record_details TEXT,
    FOREIGN KEY (customer_id) REFERENCES customers(customer_id) ON UPDATE CASCADE ON DELETE CASCADE,
...
CREATE TABLE pet_enclosures (
    pet_enclosure_id INT AUTO_INCREMENT PRIMARY KEY,
    customer_id INT NOT NULL,
    pet_id INT NOT NULL,
    pet_enclosure_number INT NOT NULL,
    check_in_date TIMESTAMP NOT NULL,
    check_out_date TIMESTAMP,
    daily_rate INT NOT NULL,
    deposit INT DEFAULT 0,
    emergency_limit INT DEFAULT 0,
    pet_enclosure_note TEXT,
    pet_enclosure_status VARCHAR(20) NOT NULL,
    FOREIGN KEY (customer_id) REFERENCES customers(customer_id) ON UPDATE CASCADE ON DELETE CASCADE,
    FOREIGN KEY (pet_id) REFERENCES pets(pet_id) ON UPDATE CASCADE ON DELETE CASCADE
);
...
CREATE TABLE treatment_sessions (
    treatment_session_id INT AUTO_INCREMENT PRIMARY KEY,
    treatment_course_id INT NOT NULL,
    doctor_id INT NOT NULL,
    treatment_session_datetime TIMESTAMP NOT NULL,
...
CREATE TABLE diagnoses (
    ...
    diagnosis_type VARCHAR(1) NOT NULL,
    clinical_tests TEXT,
    notes TEXT,
...
-- === MEDICAL RECORD SERVICES (dịch vụ đã thêm trong lượt khám) ===
